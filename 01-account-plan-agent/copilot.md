...
1. **Find the account** — Use the People.ai find_account plugin with the account name to get the account ID and opportunity list.
...
Configure these plugins in your Copilot agent to connect to People.ai:
...
4. Under **Plugins**, configure API endpoints for each People.ai MCP tool listed above
