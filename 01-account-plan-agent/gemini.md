...
1. **Find the account** — Use the People.ai find_account extension with the account name to get the account ID and opportunity list.
...
Configure these extensions in your Gemini Gem to connect to People.ai:
...
4. Under **Extensions**, configure API endpoints for each People.ai MCP tool listed above
