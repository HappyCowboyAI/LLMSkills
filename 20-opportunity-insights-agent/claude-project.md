...
4. Under **MCP Servers**, connect the People.ai MCP
5. Optionally upload `PeopleaiMetricLibrary.csv` as project knowledge for metric slug lookups

## How to Use
Type "Build my pipeline dashboard" or "Analyze my pipeline" and press Enter. The agent will pull live data from People.ai MCP, classify deals, and render an interactive dashboard.
