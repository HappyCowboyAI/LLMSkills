...
1. **Find the account** — Use the People.ai find_account plugin to get the account ID and opportunity list.
...
5. Under **Plugins**, configure API endpoints for each People.ai tool
