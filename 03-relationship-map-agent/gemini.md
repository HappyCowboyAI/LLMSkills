...
1. **Find the account** — Use the People.ai find_account extension to get the account ID, opportunities, domain, and owner. Calculate total revenue across opportunities.
